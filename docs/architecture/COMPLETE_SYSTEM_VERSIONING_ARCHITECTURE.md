...
| **Database Schema** | Timestamped | `2025.09.05-1430` | Schema evolution |
...
Headers on every response:
  API-Version: 1.7.0
  API-Path-Major: v1
  Schema-Version: 2025.09.05-1430
...
GET /api/v1/version
{
  "api_version": "1.7.0",
  "api_path_major": "v1",
  "schema_version": "2025.09.05-1430",
  "deprecation": false,
  "sunset_date": null,
...
Database: Bump to 1.0.1
Web: Bump to 1.0.1
Mobile: Bump to 1.0.1
```
...
Database: Bump to 1.1.0
Web: Bump to 1.1.0
Mobile: Bump to 1.1.0
```
...
├── API Service: v1.2.3 (path: /api/v1/)
├── Database Schema: v1.2.3
├── Web Frontend: v1.2.3
└── Mobile App: v1.2.3

Compatibility Matrix:
├── API v1.0.0 ← → Mobile 1.0.0 - 1.5.0
├── API v1.1.0 ← → Mobile 1.1.0 - 1.8.0
├── API v1.2.0 ← → Mobile 1.2.0 - 2.0.0
└── API v2.0.0 ← → Mobile 2.0.0+
```
...
- **Version adoption**: 95% adoption within 30 days
...
- **Database Updates**: Migration scripts with rollback capability
...
async def add_version_headers(request: Request, call_next):
    ...
    response.headers["Schema-Version"] = "2025.01.15-0000"
    return response
```
...
async def get_version():
    return {
        "api_version": "1.0.0",
        "api_path_major": "v1",
        "schema_version": "2025.01.15-0000",
        "deprecation": False,
        "sunset_date": None,
        "min_supported_client": "1.0.0"
    }
